...
public class RsaSigningTool {
    ...
    private static boolean verify(String payload, String signatureBase64, PublicKey publicKey) throws Exception {
        Signature signature = Signature.getInstance(SIGNATURE_ALGORITHM);
    ...
    private static PrivateKey parsePrivateKey(String privateKeyBase64) throws Exception {
